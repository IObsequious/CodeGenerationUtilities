...
{
    public class CodeDomAssistant : ICodeGenerator, ICodeParser
    {
        private readonly Hashtable codedomVar = new Hashtable();

        private static readonly Dictionary<Type, string> NameTable =
            new Dictionary<Type, string>
            {

                { typeof(CodeArgumentReferenceExpression),"argumentReferenceExpression"},
                { typeof(CodeArrayCreateExpression),"arrayCreateExpression"},
                { typeof(CodeArrayIndexerExpression),"arrayIndexerExpression"},
                { typeof(CodeAssignStatement),"assignStatement"},
                { typeof(CodeAttachEventStatement),"attachEventStatement"},
                { typeof(CodeAttributeArgument),"attributeArgument"},
                { typeof(CodeAttributeArgumentCollection),"attributeArgumentCollection"},
                { typeof(CodeAttributeDeclaration),"attributeDeclaration"},
                { typeof(CodeAttributeDeclarationCollection),"attributeDeclarationCollection"},
                { typeof(CodeBaseReferenceExpression),"baseReferenceExpression"},
                { typeof(CodeBinaryOperatorExpression),"binaryOperatorExpression"},
                { typeof(CodeBinaryOperatorType),"binaryOperatorType"},
                { typeof(CodeCastExpression),"castExpression"},
                { typeof(CodeCatchClause),"catchClause"},
                { typeof(CodeCatchClauseCollection),"catchClauseCollection"},
                { typeof(CodeChecksumPragma),"checksumPragma"},
                { typeof(CodeComment),"comment"},
                { typeof(CodeCommentStatement),"commentStatement"},
                { typeof(CodeCommentStatementCollection),"commentStatementCollection"},
                { typeof(CodeCompileUnit),"unit"},
                { typeof(CodeConditionStatement),"conditionStatement"},
                { typeof(CodeConstructor),"constructor"},
                { typeof(CodeDefaultValueExpression),"defaultValueExpression"},
                { typeof(CodeDelegateCreateExpression),"delegateCreateExpression"},
                { typeof(CodeDelegateInvokeExpression),"delegateInvokeExpression"},
                { typeof(CodeDirectionExpression),"directionExpression"},
                { typeof(CodeDirective),"directive"},
                { typeof(CodeDirectiveCollection),"directiveCollection"},
                { typeof(CodeEntryPointMethod),"entryPointMethod"},
                { typeof(CodeEventReferenceExpression),"eventReferenceExpression"},
                { typeof(CodeExpression),"expression"},
                { typeof(CodeExpressionCollection),"expressionCollection"},
                { typeof(CodeExpressionStatement),"expressionStatement"},
                { typeof(CodeFieldReferenceExpression),"fieldReferenceExpression"},
                { typeof(CodeGotoStatement),"gotoStatement"},
                { typeof(CodeIndexerExpression),"indexerExpression"},
                { typeof(CodeIterationStatement),"iterationStatement"},
                { typeof(CodeLabeledStatement),"labeledStatement"},
                { typeof(CodeLinePragma),"linePragma"},
                { typeof(CodeMemberEvent),"memberEvent"},
                { typeof(CodeMemberField),"memberField"},
                { typeof(CodeMemberMethod),"memberMethod"},
                { typeof(CodeMemberProperty),"memberProperty"},
                { typeof(CodeMethodInvokeExpression),"methodInvokeExpression"},
                { typeof(CodeMethodReferenceExpression),"methodReferenceExpression"},
                { typeof(CodeMethodReturnStatement),"methodReturnStatement"},
                { typeof(CodeNamespace),"ns"},
                { typeof(CodeNamespaceCollection),"namespaceCollection"},
                { typeof(CodeNamespaceImport),"namespaceImport"},
                { typeof(CodeNamespaceImportCollection),"namespaceImportCollection"},
                { typeof(CodeObject),"obj"},
                { typeof(CodeObjectCreateExpression),"objectCreateExpression"},
                { typeof(CodeParameterDeclarationExpression),"parameterDeclarationExpression"},
                { typeof(CodeParameterDeclarationExpressionCollection),"parameterDeclarationExpressionCollection"},
                { typeof(CodePrimitiveExpression),"primitiveExpression"},
                { typeof(CodePropertyReferenceExpression),"propertyReferenceExpression"},
                { typeof(CodePropertySetValueReferenceExpression),"propertySetValueReferenceExpression"},
                { typeof(CodeRegionDirective),"regionDirective"},
                { typeof(CodeRegionMode),"regionMode"},
                { typeof(CodeRemoveEventStatement),"removeEventStatement"},
                { typeof(CodeSnippetCompileUnit),"snippetCompileUnit"},
                { typeof(CodeSnippetExpression),"snippetExpression"},
                { typeof(CodeSnippetStatement),"snippetStatement"},
                { typeof(CodeSnippetTypeMember),"snippetTypeMember"},
                { typeof(CodeStatement),"statement"},
                { typeof(CodeStatementCollection),"statementCollection"},
                { typeof(CodeThisReferenceExpression),"thisReferenceExpression"},
                { typeof(CodeThrowExceptionStatement),"throwExceptionStatement"},
                { typeof(CodeTryCatchFinallyStatement),"tryCatchFinallyStatement"},
                { typeof(CodeTypeConstructor),"typeConstructor"},
                { typeof(CodeTypeDeclaration),"typeDeclaration"},
                { typeof(CodeTypeDeclarationCollection),"typeDeclarationCollection"},
                { typeof(CodeTypeDelegate),"typeDelegate"},
                { typeof(CodeTypeMember),"typeMember"},
                { typeof(CodeTypeMemberCollection),"typeMemberCollection"},
                { typeof(CodeTypeOfExpression),"typeOfExpression"},
                { typeof(CodeTypeParameter),"typeParameter"},
                { typeof(CodeTypeParameterCollection),"typeParameterCollection"},
                { typeof(CodeTypeReferenceOptions),"typeReferenceOptions"},
                { typeof(CodeTypeReference),"typeReference"},
                { typeof(CodeTypeReferenceCollection),"typeReferenceCollection"},
                { typeof(CodeTypeReferenceExpression),"typeReferenceExpression"},
                { typeof(CodeVariableDeclarationStatement),"variableDeclarationStatement"},
                { typeof(CodeVariableReferenceExpression),"variableReferenceExpression"},
                { typeof(FieldDirection),"fieldDirection"},
                { typeof(MemberAttributes),"memberAttributes"},
                { typeof(CodeCompiler),"compiler"},
                { typeof(CodeDomProvider),"domProvider"},
                { typeof(CodeGenerator),"generator"},
                { typeof(CodeGeneratorOptions),"generatorOptions"},
                { typeof(CodeParser),"parser"},
                { typeof(CompilerError),"compilerError"},
                { typeof(CompilerErrorCollection),"compilerErrorCollection"},
                { typeof(CompilerInfo),"compilerInfo"},
                { typeof(CompilerParameters),"compilerParameters"},
                { typeof(CompilerResults),"compilerResults"},
                { typeof(Executor),"executor"},
                { typeof(GeneratedCodeAttribute),"generatedAttribute"},
                { typeof(GeneratorSupport),"generatorSupport"},
                { typeof(ICodeCompiler),"compiler"},
                { typeof(ICodeGenerator),"generator"},
                { typeof(ICodeParser),"parser"},
                { typeof(IndentedTextWriter),"indentedTextWriter"},
                { typeof(LanguageOptions),"languageOptions"},
                { typeof(TempFileCollection),"tempFileCollection"}
            };
        ...
        public CodeDomAssistant()
        {
        }

        public CodeDomAssistant(TextWriter output)
        {
            this.output = output;
        }
        ...
        private static string MakeValid(string identifier)
        {
            StringBuilder builder = new StringBuilder();
            for (int i = 0; i < identifier.Length && builder.Length < 511; i++)
            {
                char c = identifier[i];
                if (IsValid(c))
                {
        ...
        private string GetNextVar(Type type)
        {
            string typeName = NameTable[type];

            if (codedomVar.ContainsKey(typeName))
            {
                int id = (int)codedomVar[typeName] + 0b1;
                codedomVar[typeName] = id;
                return MakeName(typeName) + id;
            }
            codedomVar[typeName] = 0b1;
            return MakeName(typeName);
        }
        ...
        {
            string name = GetNextVar(typeof(CodeAttributeArgument));
        ...
        {
            string name = GetNextVar(typeof(CodeAttributeDeclaration));
        ...
        {
            string name = GetNextVar(typeof(CodeCatchClause));
        ...
        {
            string name = GetNextVar(typeof(CodeComment));
        ...
        {
            string name = GetNextVar(typeof(CodeCompileUnit));
        ...
        private string GenerateCodeEventReferenceExpression(string context, CodeEventReferenceExpression e, TextWriter w, CodeGeneratorOptions o)
        {
            ...
            string name = GetNextVar(typeof(CodeEventReferenceExpression));
        ...
        private string GenerateCodeExpression(string context, CodeExpression e, TextWriter w, CodeGeneratorOptions o)
        {
            ...
            if (e is CodeMethodInvokeExpression)
            {
                ...
                string name = GetNextVar(typeof(CodeMethodInvokeExpression));
            ...
            if (e is CodeMethodReferenceExpression)
            {
                ...
                string name = GetNextVar(typeof(CodeMethodReferenceExpression));
            ...
            if (e is CodeDelegateInvokeExpression)
            {
                ...
                string name = GetNextVar(typeof(CodeDelegateInvokeExpression));
            ...
            if (e is CodeObjectCreateExpression)
            {
                ...
                string name = GetNextVar(typeof(CodeObjectCreateExpression));
            ...
            if (e is CodeDirectionExpression)
            {
                ...
                string name = GetNextVar(typeof(CodeDirectionExpression));
            ...
            if (e is CodePrimitiveExpression)
            {
                ...
                string name = GetNextVar(typeof(CodePrimitiveExpression));
            ...
            if (e is CodePropertyReferenceExpression)
            {
                ...
                string name = GetNextVar(typeof(CodePropertyReferenceExpression));
            ...
            if (e is CodePropertySetValueReferenceExpression)
            {
                ...
                string name = GetNextVar(typeof(CodePropertySetValueReferenceExpression));
            ...
            if (e is CodeThisReferenceExpression)
            {
                ...
                string name = GetNextVar(typeof(CodeThisReferenceExpression));
            ...
            if (e is CodeTypeReferenceExpression)
            {
                ...
                string name = GetNextVar(typeof(CodeTypeOfExpression));
            ...
            if (e is CodeTypeOfExpression)
            {
                ...
                string name = GetNextVar("typeofExpr");
        ...
        private string GenerateCodeNamespace(string context, CodeNamespace ns, TextWriter w, CodeGeneratorOptions o)
        {
            ...
            w.WriteLine("//");
            string name = GetNextVar(typeof(CodeNamespace));
        ...
        private string GenerateCodeParameterDeclarationExpression(string context, CodeParameterDeclarationExpression arg, TextWriter w, CodeGeneratorOptions o)
        {
            ...
            w.WriteLine(@"CodeParameterDeclarationExpression {0} = new CodeParameterDeclarationExpression({1}, ""{2}"");", name, GenerateCodeTypeReference(null, arg.Type, w, o), arg.Name);
        ...
        private string GenerateCodeStatement(string context, CodeStatement e, TextWriter w, CodeGeneratorOptions o)
        {
            ...
            */
            ...
            if (e is CodeLabeledStatement)
            {
                ...
                string name = GetNextVar(typeof(CodeLabeledStatement));
        ...
        private string GenerateCodeTypeDeclaration(string context, CodeTypeDeclaration decl, TextWriter w, CodeGeneratorOptions o)
        {
            ...
            w.WriteLine("//");
            string name = GetNextVar(typeof(CodeTypeDeclaration));
            w.WriteLine(@"CodeTypeDeclaration {0} = new CodeTypeDeclaration(""{1}"");", name, decl.Name);
            w.WriteLine("{0}.TypeAttributes = {1};", name, GetTypeAttributes(decl.TypeAttributes));

            if (decl.TypeAttributes.HasFlag(TypeAttributes.Abstract))
                if (decl.IsPartial)
                {
        ...
        private string GenerateCodeTypeMember(string context, CodeTypeMember m, TextWriter w, CodeGeneratorOptions o)
        {
            ...
            if (m is CodeConstructor)
            {
                ...
                string name = GetNextVar(typeof(CodeConstructor));
            ...
            if (m is CodeMemberEvent)
            {
                ...
                string name = GetNextVar(typeof(CodeMemberEvent));
                w.WriteLine("//");
            ...
            if (m is CodeMemberProperty)
            {
                ...
                string name = GetNextVar(typeof(CodeMemberProperty));
                string parameters = string.Empty;
                foreach (CodeParameterDeclarationExpression param in member.Parameters)
                {
                    if (parameters.Length > 0b0)
            ...
            if (m is CodeMemberMethod)
            {
                ...
                string name = GetNextVar(typeof(CodeMemberMethod));
                string parameters = string.Empty;
                foreach (CodeParameterDeclarationExpression param in member.Parameters)
                {
                    if (parameters.Length > 0b0)
        ...
        {
            string name = GetNextVar(typeof(CodeTypeParameter));
        ...
        private string GenerateCodeTypeReference(string context, CodeTypeReference typeref, TextWriter w, CodeGeneratorOptions o)
        {
            ...
            string name = GetNextVar(typeof(CodeTypeReference));

            CodeTypeReference elementType = codeTypeReference.ArrayElementType;
            if (elementType == null)
            {
                if (typeref.TypeArguments.Count > 0)
                {
                    w.WriteLine(@"CodeTypeReference {0} = new CodeTypeReference(""{1}"", {2});", name, MakeBetterName(typeref.BaseType), codeTypeReference.SafeGetTypeArgumentsAsString());
                }
                else
                {
        ...
        private string GetTypeAttributes(TypeAttributes attributes)
        {
            ...
            foreach (TypeAttributes attr in (TypeAttributes[])Enum.GetValues(typeof(TypeAttributes)))
            {
                if ((attr & attributes) == attr)
                {
                    ...
                    val += "TypeAttributes." + attr;
                }
            }
            if (val.Length == 0b0)
            {
                val = "TypeAttributes.Private";
            }
            return val;
        }
